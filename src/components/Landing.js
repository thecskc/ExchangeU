...
import pickCoachLogo from "../assets/choose.svg";
...
const reviews = [
  { name: "Mo", review: `Overall I found my Exchange experience very helpful and
  ...
  { name: "Jev" , review: `I would give my coach a 4.75/5. He was very good at making sure
  ...
  { name: "Hsiang" , review: ` My coach was very attentive to what I needed. I really needed
  ...
  { name: "Moon", review: `I read a lot of books such as CTCI but I was not able to get to
  ...
  { name: "Daniel", review: `My 3 sessions with my technical interview coach Kim were great!
        ...
        return (
            <div className="landing-container">
                <div id="particles-js" className="landing-hero">
                    ...
                    >
                        ...
                        <polygon
                            ...
                            fill="#ff6347"
                        />
                        <circle cx="216.19355" cy="177" r="9" fill="#ff6347"/>
                        <circle cx="240.19355" cy="177" r="9" fill="#ff6347"/>
                        <circle cx="264.19355" cy="177" r="9" fill="#ff6347"/>
                ...
                <div className="landing-container">
                    ...
                    <div className="landing-card-section">
                        <div className="landing-card">
                            ...
                            />
                            <h2>Step 1: Pick a coach</h2>
                            <br/>
                            <h4>Browse through our coaches and choose one that you like!</h4>
                            <br/>
                            <p>
                                Want a free 15-minute introductory call with any of the coaches
                                or don't find the coach for your needs? Email us at
                        ...
                        <div className="landing-card">
                            ...
                            <p>
                                ...
                                <Link to="/pricing">the pricing page</Link>
                            </p>
                        </div>
                        <div className="landing-card">
                            <img
                                ...
                                style={{width: 48, height: 48}}
                            />
                            <h2>Step 3: Start Your Training!</h2>
                            <br/>

                            <h4>
                                The Exchange team will contact you to set up your sessions!
                            </h4>
                            <br/>
                        </div>
                    </div>
                ...
                <div className="landing-blue-section">
                    <div className="landing-blue-left">
